		...
		<>
			<div className="aboutme">
				<div className="about-content">
					...
					<p>
						Currently in the final year of a Bachelor of Technology in Computer
						Science and Engineering at Techno India University, maintaining a{" "}
					...
					<p>
						...
						, and
						<span style={colorCss}>Backend</span>
						services, such as <span style={colorCss}>Node.js</span>
						with{" "}
						<span style={colorCss} className="symbol">
							Express.js
						</span>
					...
					<p>
						<span style={colorCss}>Proficient in C++</span> with a strong grasp
						of programming basics, including object-oriented programming and
						data structures, enabling effective problem-solving and solution
						development.
					</p>
					<p>
						Knowledgeable in{" "}
